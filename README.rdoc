...
This class  <tt>WashOut::SoapError </tt> has  by default  a error code and a message as attribute but you can extend it by adding more accessible_attributes to your own custom class. 
