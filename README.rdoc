...
The exception classes used <b>must inherit</b> from  <tt>WashOut::SoapError</tt>

This class  <tt>WashOut::SoapError</tt> has  by default  a error code and a message as attributes but you can extend it by adding more accessible_attributes to your own custom class. 
