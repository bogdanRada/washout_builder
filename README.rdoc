...
* {Screenshot 1}[https://f.cloud.github.com/assets/1104923/1563031/0efe630c-5058-11e3-8502-1e0b145de80c.png]
* {Screenshot 2}[https://f.cloud.github.com/assets/1104923/1563032/0f43ddb0-5058-11e3-91d1-35409d4017b0.png]
...
The exception classes used must inherit from WashoutBuilder::SoapFault and have accessible_attributes in order to show up in the documentation
...
This class has as attributes :  a faultCode, a faultString (or message) and another attribute errors. The third attribute is optional

If you only  want to send a faultcode for your exception in the webservice application you can do this

 class MyException < WashoutBuilder::SoapFault end
...
Also if you override the initialize method don't forget to call +super+ at the end of the method so that the attributes from the parent class will be correctly instantiated.
