...
Here is an example :
 ...
 soap_action "find",  :args   => {:number => :integer} , :return => :boolean, :raises => [MyCustomSoapError, MySecondExceptionClass ] , :description => "some description about this method to show in the documentation"
