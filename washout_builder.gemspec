...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'wasabi', '~> 3.3.0', '>= 3.3.0'
  s.add_development_dependency 'savon', '~> 2.5.1', '>= 2.5.1'
  s.add_development_dependency 'httpi', '~> 2.1.0', '>= 2.1.0'
  s.add_development_dependency 'nokogiri', '~> 1.6.0', '>= 1.6.0'
    
  s.add_development_dependency 'rspec-rails', '~> 2.0', '>= 2.0'
  s.add_development_dependency 'guard', '~> 2.6.1', '>= 2.6.1'
  s.add_development_dependency 'guard-rspec', '~> 4.2.9', '>= 4.2.9'
  s.add_development_dependency 'appraisal', '~> 1.0.0', '>= 1.0.0'
  ...
  s.add_development_dependency 'codeclimate-test-reporter','~> 0.3.0', '>= 0.3.0'
  s.add_development_dependency 'rvm-tester','~> 1.1.0', '>= 1.1.0'
  
  s.add_development_dependency 'capybara', '~> 2.2.1', '>= 2.2.1'
  s.add_development_dependency 'selenium-webdriver',  '~> 2.41.0', '>= 2.41.0'
  s.add_development_dependency 'headless','~> 1.0.1', '>= 1.0.1'
end
